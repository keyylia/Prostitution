...
class PaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paint" do
    assert_difference('Paint.count') do
      post paints_url, params: { paint: { date: @paint.date, description: @paint.description, image: @paint.image, title: @paint.title } }
    end
  ...
  test "should update paint" do
    patch paint_url(@paint), params: { paint: { date: @paint.date, description: @paint.description, image: @paint.image, title: @paint.title } }
