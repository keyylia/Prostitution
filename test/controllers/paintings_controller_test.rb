...
class PaintingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post paintings_url, params: { painting: { description: @painting.description, epoque: @painting.epoque, image: @painting.image, title: @painting.title } }
    end
  ...
  test "should update painting" do
    patch painting_url(@painting), params: { painting: { description: @painting.description, epoque: @painting.epoque, image: @painting.image, title: @painting.title } }
