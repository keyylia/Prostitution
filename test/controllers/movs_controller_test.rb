...
class MovsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mov" do
    assert_difference('Mov.count') do
      post movs_url, params: { mov: { date: @mov.date, description: @mov.description, image: @mov.image, title: @mov.title } }
    end
  ...
  test "should update mov" do
    patch mov_url(@mov), params: { mov: { date: @mov.date, description: @mov.description, image: @mov.image, title: @mov.title } }
