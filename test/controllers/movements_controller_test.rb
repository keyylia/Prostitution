...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post movements_url, params: { movement: { date: @movement.date, description: @movement.description, image: @movement.image, title: @movement.title } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { date: @movement.date, description: @movement.description, image: @movement.image, title: @movement.title } }
